...
function solution(cards1, cards2, k) {
  var answer = 0;
  // 두 사람이 오름차순 숫자 놓기 게임을 하려고 합니다. 오름차순 숫자 놓기 게임이란 턴을 번갈아 가면서 카드를 1장 이상 내려놓아 두 사람의 손에 있는 카드를 모두 내려놓으면 끄탄느 게임입니다.
  // 카드를 내려놓을 때 카드의 숫자가 오름차순이 되도록 내려놓아야 합니다.
  // 입출력 예
  // cards1 = [1, 3, 5, 7]
  // cards2 = [2, 4, 6, 8]
  // k = 6
